...
echo
echo "------------------------------------------------------------"
echo "1.1. L3 API のアクセストークン取得のためのクライアントシークレット、およびAPI認可モデル・データ参照用のStore ID"
echo "------------------------------------------------------------"
...
echo
echo "------------------------------------------------------------"
echo "3. OpenFGAストアへのタプル登録"
echo "------------------------------------------------------------"

echo
echo "------------------------------------------------------------"
echo "3.1. OpenFGA API認可データの登録"
echo "------------------------------------------------------------"

USER_STORE_ID="${API_AUTHZ_STORE_ID}"
