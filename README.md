...
| `04_run-tutorial.sh`        | Run the L3 tutorial steps. Work in progress. https://github.com/open-dataspaces/L3-identity-component/blob/v1.0.0/docs/tutorials/tutorials.md#2-1-5-事業者クライアントシークレット取得         |
